...
### Retroalimentación
La separación de responsabilidades ahora es más clara: `app.js` maneja la lógica principal, `singleton.js` controla la instancia única y `storage.js` se encarga de la persistencia. Falta completar la funcionalidad de **edición** o verificar que funcione correctamente y realizar pruebas de estabilidad en operaciones de eliminación y actualización.
